---
title: solar应急响应-2025.7月
date: 2026-07-01 17:39:55
tags:
  - solar
categories:
  - 比赛
...
![在这里插入图片描述|531x75](https://i-blog.csdnimg.cn/direct/43ec31ff6aa342108849ca49499c9c48.png#pic_center)
...
- `o 0xfffff8a0000a8010o`：指定注册表 hive 的虚拟地址

`0xfffff8a0000a8010`：SAM 注册表 hive 的内存地址

- `K "SAM\\Domains\\Account\\Users\\Names"K`：指定要读取的注册表路径
...
1. webshell连接地址 - [](http://xn--89qrps7gw8tv9bx40bugp/shell.php)[http://攻击者的服务器/shell.php](http://xn--89qrps7gw8tv9bx40bugp/shell.php)
2. 攻击者服务器IP和端口
...
![在这里插入图片描述|531x133](https://i-blog.csdnimg.cn/direct/4f694eae2962473d94089839d41e1860.png#pic_center)
